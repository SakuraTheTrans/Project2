...
public class Main {
    ...
    static void editTask() {
        ...
        while (true) {
            ...
            try {
                ...
                input.nextLine();
                if (userTaskSelection > (taskList.size()-1)){
        ...
        switch (userEditSelection) {
            case 1 -> taskList.get(userTaskSelection).setTitle(userTitleChange);
            case 2 -> taskList.get(userTaskSelection).setDesc(userDescChange);
            case 3 -> taskList.get(userTaskSelection).setPriority(userPriorityChange);
        }
    }
    ...
    static void removeTask() {
        ...
        while (true) {
            ...
            taskList.remove(userTaskSelection);
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task("Fix Login Bug", "Resolve issue where users cannot log in with special characters.", 4);
        Task task2 = new Task("Update UI", "Redesign the dashboard for a more modern look.", 3);
        Task task3 = new Task("Write Documentation", "Complete API documentation for the new authentication system.", 2);
